    ...
    return (
        <div className="star-rating">
            ...
            <span className="rating_stars rating_0">
                ...
                <span className='r r0_5' data-rating='1' data-value='0.5'></span>
                <span className='r r1' data-rating='1' data-value='1'></span>
                <span className='r r1_5' data-rating='15' data-value='1.5'></span>
                <span className='r r2' data-rating='2' data-value='2'></span>
                <span className='r r2_5' data-rating='25' data-value='2.5'></span>
                <span className='r r3' data-rating='3' data-value='3'></span>
                <span className='r r3_5' data-rating='35' data-value='3.5'></span>
                <span className='r r4' data-rating='4' data-value='4'></span>
                <span className='r r4_5' data-rating='45' data-value='4.5'></span>
